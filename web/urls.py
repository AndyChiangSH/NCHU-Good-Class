...
urlpatterns = [
    ...
    path('profile/edit/<int:id>', views.profile_edit, name="profile_edit"),    # 編輯個人資料
    path('profile/comments/<int:id>', views.profile_comment_list, name="profile_comment_list"),    # 個人評論清單
    path('profile/follows/<int:id>', views.profile_follow_list, name="profile_follow_list"),    # 個人評論清單
