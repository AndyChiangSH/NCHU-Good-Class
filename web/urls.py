...
urlpatterns = [
    ...
    path('profile/comments/', views.profile_comment_list,
         name="profile_comment_list"),    # 個人評論清單
    path('profile/follows/', views.profile_follow_list,
         name="profile_follow_list"),    # 個人評論清單
    path('comment/create/<str:id>', views.comment_create,
         name="comment_create"),     # 新增評論
    path('comment/edit/<int:id>', views.comment_edit,
         name="comment_edit"),     # 編輯評論
    path('comment/delete/<int:id>', views.comment_delete,
         name="comment_delete"),   # 刪除評論
